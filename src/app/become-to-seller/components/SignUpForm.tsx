/*
|-----------------------------------------
| setting up SignUpForm for the App
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <motion.button
        ...
        whileHover="hover"
        type="submit"
        className="w-full cursor-pointer bg-red-600 text-white py-3 rounded-md font-medium focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
      >
        Register Your Shop
      </motion.button>
    </form>
